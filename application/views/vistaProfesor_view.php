                        ...
                        <?php 
                            ...
                            foreach ($dataTable->result() as $rowHorario) {
                                if ($rowHorario->Dia == 'Lunes') {
                                    $i++;
                                    echo "<td class='desc'>Materia: ".$rowHorario->DescMat."<br>Hora Inicio: ".$rowHorario->HoraInicio."<br>Hora final: ".$rowHorario->HoraFin."<br>Salon: ".$rowHorario->DescSalon."</td>";
                                    echo "<td class='mobile'>".$rowHorario->DescMat."<br>".$rowHorario->HoraInicio."<br>".$rowHorario->HoraFin."<br>".$rowHorario->DescSalon."</td>";
                                }
                            }
